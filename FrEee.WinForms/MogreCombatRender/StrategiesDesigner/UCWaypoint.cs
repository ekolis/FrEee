...
{
    public partial class UCWaypoint : UCStratBlock
    {

        public StrategyWayPoint wpnt { get { return (StrategyWayPoint)base.stratblock; } set { base.stratblock = value; } }

        public UCWaypoint(StratMainForm ParentForm, Canvasdata canvasdata)
            : base(new StrategyWayPoint(), ParentForm, canvasdata, false)
        {
            InitializeComponent();
