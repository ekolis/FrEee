...
namespace FrEee.WinForms.Controls {
    public partial class ComponentReport : UserControl, IBindable<Component>, IBindable<MountedComponentTemplate>, IBindable<ComponentTemplate> {
        public ComponentReport() {
            ...
            //wpfHost.Child = new ComponentReportView();
        }

        public ComponentReport(Component comp) : this() {
            Bind(comp);
        }

        public ComponentReport(MountedComponentTemplate mct) : this() {
            Bind(mct);
        }

        public ComponentReport(ComponentTemplate ct) : this() {
            Bind(ct);
        }
