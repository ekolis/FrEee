		...
		public static void DealWithMines(this ISpaceObject sobj)
		{
			if (sobj is IDamageable && sobj is IOwnable)
			{
				...
				if (minesDetonated.Any() || minesSwept.Any() || minesAttacking.Any())
					owner.Owner.Log.Add(sobj.CreateLogMessage(sobj + " encountered a mine field at " + sector + " and took " + totalDamage + " points of damage, sweeping " + minesSwept.Sum(kvp => kvp.Value) + " mines."));
