...
{
	// XXX: Just use this class as a temporary holder for links between IDs and objects; add a [SerializeAsModID] attribute to replace all the duplicated properties
	/// <summary>
