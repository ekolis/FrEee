...
namespace FrEee.Game.Setup
{
    ...
    /// </summary>
    public class EmpireTemplate : ITemplate<Empire>, INotifyPropertyChanged
    {
        ...
        public string LeaderName
        {
            ...
            set
            {
                ...
                _leaderName = value;
                NotifyPropertyChanged(nameof(LeaderName));
            }
        }
        ...
        private string _insigniaName;
        /// <summary>
        /// The name of this empire's insignia.
        /// </summary>
        public string InsigniaName
        {
            get { return _insigniaName; }
            set
            {
                if (_insigniaName == value) return;

                _insigniaName = value;
                NotifyPropertyChanged(nameof(InsigniaName));
            }
        }
        ...
        {
            get { return _shipsetName; }
            set
            {
                if (_shipsetName == value) return;

                _shipsetName = value;
                NotifyPropertyChanged(nameof(ShipsetName));
            }
        }

        private string _leaderPortraitName;
        /// <summary>
        /// The name of the leader portrait used by this empire.
        /// </summary>
        public string LeaderPortraitName
        {
            get { return _leaderPortraitName; }
            set
            {
                if (_leaderPortraitName == value) return;

                _leaderPortraitName = value;
                NotifyPropertyChanged(nameof(LeaderPortraitName));
            }
        }
