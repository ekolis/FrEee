...
namespace FrEee.Game.Objects.Combat2
{
    public class CombatVehicle : CombatObject
    {
        ...
        public CombatVehicle(SpaceVehicle start_v, SpaceVehicle working_v, int battleseed)
        ...
        public CombatVehicle(ICombatant startObj, ICombatant workingObj, int battleseed)
            : base(new Point3d(0, 0, 0), new Point3d(0, 0, 0), startObj.ID)
        {
            icomobj_WorkingCopy = workingObj;

            icomobj_StartCopy = startObj;
