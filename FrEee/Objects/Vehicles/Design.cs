...
namespace FrEee.Objects.Vehicles
{
	...
	public static class Design
	{
		...
		public static IEnumerable<IDesign> ImportFromLibrary()
		{
			...
			designs.SafeForeach(d =>
			{
				d.IsNew = true;
				d.Owner = Empire.Current;
				d.TurnNumber = The.Game.TurnNumber;
	...
	public class Design<T> : IDesign, ITemplate<T> where T : IVehicle
	{
		...
		{
			get { return The.Game.Referrables.OfType<T>().Where(v => v.Design == this); }
		}
		...
		public Visibility CheckVisibility(Empire emp)
		{
			...
			else if (emp.KnownDesigns.Contains(this) || The.Galaxy.Battles.Any(b =>
