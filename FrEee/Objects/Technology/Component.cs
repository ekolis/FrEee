...
namespace FrEee.Objects.Technology
{
	...
	public class Component : IAbilityObject, INamed, IPictorial, IDamageable, IContainable<IVehicle>, IFormulaHost, IUpgradeable<Component>
	{
		...
		{
			get { return The.Galaxy.FindSpaceObjects<IVehicle>().SelectMany(v => v.Components).Where(c => Template.UpgradesTo(c.Template)); }
		}
		...
		{
			get { return The.Galaxy.FindSpaceObjects<IVehicle>().SelectMany(v => v.Components).Where(c => c.Template.UpgradesTo(Template)); }
		}
